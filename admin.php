...
<main>
   <div class="font-[sans-serif] max-w-7xl mx-auto h-screen">
      <div class="grid md:grid-cols-2 items-center gap-8 h-full">
         <form class="max-w-lg max-md:mx-auto w-full p-6" action="process_login_admin.php" method="post">
            <div class="mb-8">
            ...
            <div class="flex flex-wrap items-center gap-4 justify-between mt-4">
               ...
               <div class="text-sm">
                  <a href="jajvascript:void(0);" class="text-primary font-semibold hover:underline">
