<nav id="sidebar" class="lg:min-w-[250px] w-max max-lg:min-w-8">
   <div id="sidebar-collapse-menu"
      ...
      <div class="pt-8 pb-2 px-6 sticky top-0 bg-white min-h-[80px] z-[100]">
         <a href="/fik-corner/penyelenggara/dashboard" class="outline-none"><img
               src="/fik-corner/assets/fik-corner-logo.png" alt="logo" class='w-[170px]' />
         </a>
      </div>
      ...
      <div class="py-6 px-6">
         ...
         <ul class="space-y-2">
            ...
            <li>
               <a href="/fik-corner/penyelenggara/menunggu-verifikasi"
                  class="menu-item text-gray-800 text-sm flex items-center cursor-pointer hover:bg-secondary rounded-md px-3 py-3 transition-all duration-300">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-[18px] h-[18px] mr-4"
                     viewBox="0 0 64 64">
                     <path
            ...
            <li>
               <a href="/fik-corner/penyelenggara/aktif"
                  class="menu-item text-gray-800 text-sm flex items-center cursor-pointer hover:bg-secondary rounded-md px-3 py-3 transition-all duration-300">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-[18px] h-[18px] mr-4"
            ...
            <li>
               <a href="/fik-corner/penyelenggara/selesai"
                  class="menu-item text-gray-800 text-sm flex items-center cursor-pointer hover:bg-secondary rounded-md px-3 py-3 transition-all duration-300">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class=" w-[18px] h-[18px] mr-4"
                     viewBox="0 0 512 512">
                     <path
            ...
            <li>
               <a href="/fik-corner/penyelenggara/ditolak"
                  class="menu-item text-gray-800 text-sm flex items-center cursor-pointer hover:bg-secondary rounded-md px-3 py-3 transition-all duration-300">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-[18px] h-[18px] mr-4"
