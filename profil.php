<?php
   ...
   // Query data pengguna berdasarkan NIM
   $columns = "users.*";
   $table = "users";
   $join = "";
   $where = "users.nim = '$nim'";
...
<main class="w-full flex-grow pt-20 px-4 sm:px-6 md:px-10 lg:px-16 xl:px-28">
   ...
   enctype="multipart/form-data" class="max-w-lg max-md:mx-auto w-full">
      ...
      <div data-collapse="collapse" action="ubah_profil.php"
      ...
      <div class="mt-4">
         ...
         <div class="relative flex items-center">
            <input name="nomor_telepon" type="text" value="<?= htmlspecialchars($data[0]['nomor_telepon']); ?>" 
               class="w-full text-sm text-gray-800 bg-gray-100 focus:bg-transparent px-4 py-3.5 rounded-md outline-blue-600"
