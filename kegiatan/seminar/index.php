...
<main class="w-full h-full pt-20 lg:px-28 md:px-14 sm:px-6 flex-grow">
   <div class='mt-8'>
      <div class="mb-5">
         <p class="font-bold text-2xl">Seminar</p>
      </div>
      ...
      <div class='max-w-auto'>
         <div
            ...
            <?php 
               ...
               ";
               $where = "(status = 'Aktif' OR status = 'Selesai') AND kategori_kegiatan.kategori = 'Seminar'";
